...
Este site foi criado para que seus usuarios possam comprimir e unir PDFs sem instalar Python, Ghostscript ou qualquer outra ferramenta local.
...
3. Escolha entre `Compressao` e `Uniao`.
